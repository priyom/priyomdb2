...
--
-- Dumping data for table `session_capabilities`
--

LOCK TABLES `session_capabilities` WRITE;
/*!40000 ALTER TABLE `session_capabilities` DISABLE KEYS */;
/*!40000 ALTER TABLE `session_capabilities` ENABLE KEYS */;
UNLOCK TABLES;
